...
export default function Edit({ attributes, setAttributes }) {
	const { accentText, headingText, mediaId, mediaUrl, mediaAlt, steps } = attributes;
	...
	return (
		<div {...blockProps}>
			...
			<div className="s2e-project-steps__grid">
				<div className="s2e-project-steps__media">
					<div className="s2e-project-steps__image">
						<MediaUploadCheck>
							<MediaUpload
								onSelect={(media) =>
									setAttributes({
									...
									<div>
										{mediaUrl ? (
											...
											<Button variant="secondary" onClick={open}>
												{__('Choose featured image', 'six2eight-elements')}
											</Button>
										)}
										<div style={{ marginTop: 8 }}>
											<Button variant="link" onClick={open}>
												{mediaUrl
													? __('Replace image', 'six2eight-elements')
													: ''}
											</Button>
										</div>
									</div>
				...
				<div className="s2e-project-steps__content">
